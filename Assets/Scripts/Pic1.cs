...
public class Pic1 : MonoBehaviour {
	...
	void OnGUI() 
	{
		GUI.Label (new Rect (0, 0.25f *screen_height,  screen_width, screen_height), bgpic);
		...
		if (showMsg) {
			...
			GUI.Label (new Rect (0, 100, (1000.0f / 1280.0f) * screen_width, screen_height), gc);
		}
